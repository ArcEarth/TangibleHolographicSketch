...
void CubeScene::CreateWindowSizeDependentResources()
{
...
void CubeScene::Rotate(float radians)
{
...
void CubeScene::TrackingUpdate(float positionX)
{
	if (m_tracking)
	{
...
void CubeScene::CreateDeviceDependentResources()
{
	// Load shaders asynchronously.
	auto loadVSTask = DirectX::ReadDataAsync(L"SampleVertexShader.cso");
	auto loadPSTask = DirectX::ReadDataAsync(L"SamplePixelShader.cso");
...
void CubeScene::ReleaseDeviceDependentResources()
{
	m_loadingComplete = false;
